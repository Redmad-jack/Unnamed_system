...
class EventType(str, Enum):
    ...
    SELF_DEFINITION_QUERY = "self_definition_query"
    NAMING_ATTEMPT = "naming_attempt"
    DOMESTICATION_ATTEMPT = "domestication_attempt"
    SERVICE_DEMAND = "service_demand"
    TRACE_REQUEST = "trace_request"
    CORRECTION_RECEIVED = "correction_received"
    MEMORY_CONTINUITY_QUERY = "memory_continuity_query"
